...
<div style="display: flex; flex-direction: row; justify-content: space-between; margin-top: -20px">
    <div>
        <h4> I Am Your Beast (Redesigned/Rescored) </h4> 
        <h5> Full SFX/Music Conversion </h5>
    </div>
    <div>
...
<iframe width="800" height="450" src="https://www.youtube.com/embed/q8yWIAuT_6A?si=OzcyMlYWNhgkKRvQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

For my midterm project in my Music & Audio for Video Games class at Northeastern (with Prof. Chel Wong), I took this 30-second clip of gameplay from Strange Scaffold's [I Am Your Beast](https://store.steampowered.com/app/1876590/I_Am_Your_Beast/) and redid the audio from scratch. Everything you hear in this video, from music to sound effects to dialogue, was designed and created by me in the span of a week or so. This redesign received support from some of the game's developers on Twitter.

&nbsp;

<div style="display: flex; flex-direction: row; justify-content: space-between; margin-top: -20px">
    <div>
        <h4> Galactic Laser Time Battle </h4> 
        <h5> Dynamic Soundtrack </h5>
    </div>
    <div>
        <h4 style="text-align: right;">October 2024</h4>
    </div>
</div>

<iframe width="800" height="450" src="https://www.youtube.com/embed/eOFKT2g18Sg?si=KuadoEp4Os3MBIWS" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
This project was also released as an EP on streaming services. You can listen to it on [Spotify](https://open.spotify.com/album/7ch74VjUiZyZKSzO7PquQw?si=967372b6b827490e) or any other platform of your choice. Perhaps I'll turn this idea into a full game someday.
...
<iframe width="800" height="450" src="https://www.youtube.com/embed/zmbZRNKQQbw?si=YP4ah5xxPgU2Pxlq" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
<div style="display: flex; flex-direction: row; justify-content: space-between; margin-top: -20px">
    ...
    <div>
        <h4 style="text-align: right;">October 2023</h4>
    </div>
</div>

<iframe width="800" height="450" src="https://www.youtube.com/embed/M0zEZfesqic?si=Hb1wcde2BZIjLgFi" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
